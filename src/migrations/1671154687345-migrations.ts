...
export class migrations1671154687345 implements MigrationInterface {
    name = 'migrations1671154687345'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "article_post" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "body" character varying(240) NOT NULL, "localization" character varying(30), "author_id" uuid, "article_quote_id" uuid, "article_reply_id" uuid, CONSTRAINT "REL_9c392d7e0d6c3bcca20d3ce21f" UNIQUE ("author_id"), CONSTRAINT "REL_6edc67d6012c52a1f9c26bc891" UNIQUE ("article_quote_id"), CONSTRAINT "REL_db85f132e339b2b99a6e297ca0" UNIQUE ("article_reply_id"), CONSTRAINT "PK_ce5968affb8e27896e7ae244bd1" PRIMARY KEY ("id"))`);
